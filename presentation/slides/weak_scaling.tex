\begin{frame}{Weak Scaling}
    ...
    \begin{figure}[h]
        ...
        \vspace{-0.2cm}
        \caption{Points indicate empirical scaled speedup (averaged over 3 runs). Dashed lines illustrate the Gustafson's Law model fit, highlighting parallel overhead scaling limits.}
    \end{figure}
