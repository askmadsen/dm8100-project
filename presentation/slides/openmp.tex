...
\begin{frame}{OpenMP Performance Comparison}
    \centering Execution times are in seconds, averaged over 3 consecutive runs using 12 threads.
    ...
    \begin{tabular}{lrrrr}
        ...
        Chunks            & 0.07 s        & 0.26 s        & 2.66 s       & 27.25 s      \\
        \bottomrule
    \end{tabular}
